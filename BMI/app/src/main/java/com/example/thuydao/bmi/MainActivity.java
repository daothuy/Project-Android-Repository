package com.example.thuydao.bmi;
...
//        editTen=(EditText) findViewById(R.id.editten);
        ...
        editChieucao=(EditText) findViewById(R.id.height);

        editCannang=(EditText) findViewById(R.id.weight);

        editBMI=(EditText) findViewById(R.id.BMI);

        editChandoan=(EditText) findViewById(R.id.result);
